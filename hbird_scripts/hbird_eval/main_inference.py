...
def main_inference(args, model_name, cluster_index_test):
    ...
    cluster_index = faiss.read_index(cluster_index_test)
    if args.dataset =='coco':
        test_set = CocoMemoryTasksDataLoader("/scratch-shared/combined_hbird/mscoco_hbird",'val', 100, args.k_spt, args.k_qry, args.img_size, cluster_index= cluster_index, transforms = (image_val_transform, shared_val_transform), cluster_assignment= '/home/lbusser/hbird_scripts/hbird_eval/data/MSCOCO_dinov2_vitb14_100_cluster_results/val/cluster_assignments.pkl')
    elif args.dataset == "nyuv2":
        test_set = NYUMemoryTasksDataLoader("/scratch-shared/combined_hbird/nyu_hbird/nyu_data/data/", 'test', 600, args.k_spt, args.k_qry, args.img_size, cluster_index= cluster_index, cluster_assignment='/home/lbusser/hbird_scripts/hbird_eval/data/NYUv2_dinov2_vitb14_100_cluster_results/cluster_assignments.pkl', transforms = (image_val_transform, shared_val_transform))
    ...
    for x_spt, y_spt, x_qry, y_qry in tqdm(db_test):
        prediction = model(x_spt, y_spt, x_qry, y_qry)
    ...
    torch.save(all_labels, '/home/lbusser/hbird_scripts/hbird_eval/data/models/predictions/' + f"nyuvq_gts_{args.dataset}.pt")
    torch.save(all_images, '/home/lbusser/hbird_scripts/hbird_eval/data/models/predictions/' + f"nyuvq_imgs_{args.dataset}.pt")
    torch.save(preds_all_test, '/home/lbusser/hbird_scripts/hbird_eval/data/models/predictions/' + f"nyuvq_preds_{args.dataset}.pt")
...
if __name__ == '__main__':
    ...
    cluster_index_test = '/home/lbusser/hbird_scripts/hbird_eval/data/NYUv2_dinov2_vitb14_100_cluster_results/cluster_index.index'

    main_inference(args, model_name = model_name, cluster_index_test = cluster_index_test)
