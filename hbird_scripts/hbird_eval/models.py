...
class BaseFeatureExtractor(torch.nn.Module, abc.ABC):
    def __init__(self):
        super().__init__()
...
class FeatureExtractorBeta(torch.nn.Module):
    ...
    # def forward_features(self, imgs, feat="k"):
    #     try:
    #         # TODO: This is a hack to get the features from the last layer.
    #         # Investigate it more.
    #         try:
    #             features, normalized_cls_attention = self.get_intermediate_layer_feats(imgs, feat=feat, layer_num=-1)
    #         except:
    ...
    #             normalized_cls_attention = None
    #         else:
    #             # In case of dino, leopart or simimilar timm models
    #             features = features[:, 1:]
    #             normalized_cls_attention = None
    #     return features, normalized_cls_attention
